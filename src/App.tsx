        ...
        if (breakMode) {
          ...
          if (settings.healthEnabled !== false) {
            ...
            if (stableState === 'focused') {
              ...
              // distracted, absent AND stretch time all count as resting —
              // once it exceeds the break threshold, the guard resets.
            ...
            // Reached N focused minutes while breaks stayed under the
            // threshold → time to remind the student to rest.
              ...
              <div className="mt-5 max-w-sm mx-auto">
                ...
                <p className="text-[10px] font-bold text-[#A0836D] mt-1.5">
                  {stableState !== 'focused'
                    ...
                    : '👀 still studying at the desk... step away and the bar will move'}
                </p>
              </div>

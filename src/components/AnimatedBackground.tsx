...
export default function AnimatedBackground() {
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none" aria-hidden="true">
      {/* The artwork with a slow cinematic camera drift, softly defocused so the UI pops */}
      <div className="absolute inset-0 kapi-kenburns">
        <img
          src={bgArt}
          alt=""
          className="w-full h-full object-cover"
          style={{ filter: 'blur(2.5px) brightness(1.02)' }}
          draggable={false}
        />
      </div>
      ...
      <div
        ...
        style={{ background: 'radial-gradient(ellipse at center, transparent 52%, rgba(70,48,28,0.16) 100%)' }}
      />
